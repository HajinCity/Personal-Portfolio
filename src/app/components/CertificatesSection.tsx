            ...
            >
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="p-3 rounded-xl bg-gradient-to-br from-[#1a7270] to-[#3a9d90] group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-start gap-4 mb-4">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-[#1a7270] to-[#3a9d90]">
